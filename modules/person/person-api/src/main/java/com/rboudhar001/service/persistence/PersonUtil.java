...
public class PersonUtil {
	...
	public static Person findByUuid_First(
		...
		throws com.rboudhar001.exception.NoSuchPersonException {
	 ...
	 * @return the matching persons
	 */
	public static List<Person> findByPerson_FullName(
		String personName, String personSurname) {

		return getPersistence().findByPerson_FullName(
	...
	public static List<Person> findByPerson_FullName(
		...
		return getPersistence().findByPerson_FullName(
			personName, personSurname, start, end);
	}
	 ...
	 * @throws NoSuchPersonException if a matching person could not be found
	 */
	public static Person findByPerson_FullName_First(
			String personName, String personSurname,
			OrderByComparator<Person> orderByComparator)
		throws com.rboudhar001.exception.NoSuchPersonException {

		return getPersistence().findByPerson_FullName_First(
	 ...
	 * @return the first matching person, or <code>null</code> if a matching person could not be found
	 */
	public static Person fetchByPerson_FullName_First(
		String personName, String personSurname,
		OrderByComparator<Person> orderByComparator) {

		return getPersistence().fetchByPerson_FullName_First(
			personName, personSurname, orderByComparator);
	}
	 ...
	 * @throws NoSuchPersonException if a matching person could not be found
	 */
	public static Person findByPerson_FullName_Last(
			String personName, String personSurname,
			OrderByComparator<Person> orderByComparator)
		throws com.rboudhar001.exception.NoSuchPersonException {

		return getPersistence().findByPerson_FullName_Last(
			personName, personSurname, orderByComparator);
	}
	 ...
	 * @return the last matching person, or <code>null</code> if a matching person could not be found
	 */
	public static Person fetchByPerson_FullName_Last(
		String personName, String personSurname,
		OrderByComparator<Person> orderByComparator) {

		return getPersistence().fetchByPerson_FullName_Last(
			personName, personSurname, orderByComparator);
	}
	 ...
	 * @throws NoSuchPersonException if a person with the primary key could not be found
	 */
	public static Person[] findByPerson_FullName_PrevAndNext(
			long personId, String personName, String personSurname,
			OrderByComparator<Person> orderByComparator)
		throws com.rboudhar001.exception.NoSuchPersonException {

		return getPersistence().findByPerson_FullName_PrevAndNext(
			personId, personName, personSurname, orderByComparator);
	}
	 ...
	 * @param personSurname the person surname
	 */
	public static void removeByPerson_FullName(
		String personName, String personSurname) {

		getPersistence().removeByPerson_FullName(personName, personSurname);
	}
	 ...
	 * @return the number of matching persons
	 */
	public static int countByPerson_FullName(
		String personName, String personSurname) {

		return getPersistence().countByPerson_FullName(
			personName, personSurname);
	}
